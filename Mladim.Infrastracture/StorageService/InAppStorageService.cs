...
namespace Mladim.Infrastracture.StorageService;
...
public class InAppStorageService : IFileStorageService
{
    ...
    public Task DeleteFileAsync(string fileRouth, string containerName)
    {
        var fileName = Path.GetFileName(fileRouth);
