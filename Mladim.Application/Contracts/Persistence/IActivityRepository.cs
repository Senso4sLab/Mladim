...
{
    Task<IEnumerable<Activity>> GetActivitiesWithParticipantsAsync(Expression<Func<Activity, bool>> predicate);
    ...
    Task<IEnumerable<ActivityWithProjectName>> GetActivitiesWithProjectNameAndMembers(Expression<Func<Activity, bool>> predicate);
